...
const ResumeDownload = ({ name }) => {
    ...
    return (
        <>
            ...
            <button
                onClick={handlePrint}
                className="fixed bottom-20 right-5 app-bg-primary hover:app-bg-primary-dark shadow-md hover:shadow-lg text-white duration-300 z-[100] rounded-full w-10 h-10 flex items-center justify-center downsifn"
