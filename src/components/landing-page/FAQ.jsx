    ...
    <>
      <div className="landingPagePadx">
        ...
        <div className="flex justify-center">
          <div className="text-center text-gray-600 md:max-w-[60%] lg:max-w-[40%]">Any other questions? Reach out on twitter or mail. You will get answers withing a few hours.</div>
        </div>
        <div className=" flex justify-center">
