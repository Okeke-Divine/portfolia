  ...
  return (
    <>
      <section className="bg-base-100" id="how">
        <div className="py-24 max-w-7xl mx-auto px-4" bis_skin_checked="1">
          <div className="flex flex-col text-center w-full mb-20" bis_skin_checked="1">
            ...
            <h2 className="sm:text-4xl text-3xl font-medium text-base-content md:mb-8">Get your business online today</h2>
          </div>
          <div className="relative" bis_skin_checked="1">
            <div className="absolute inset-x-0 hidden top-2 md:block md:px-20 lg:px-28 xl:px-44" bis_skin_checked="1">
              <div className="flex justify-center w-full" bis_skin_checked="1">
            ...
            <div className="relative grid grid-cols-1 text-center gap-y-12 md:grid-cols-3 gap-x-12" bis_skin_checked="1">
