...
const reviews = [
  {
    ...
    comment_prev_url: "https://cards.producthunt.com/cards/reviews/777696?v=1",
  },
  {
    platform: "productHunt",
    comment_prev_url: "https://cards.producthunt.com/cards/reviews/777140?v=1",
  },
  {
    ...
    name: "James Wilson",
    username: "@jamesw",
    img: "/images/avatar/b/male (2).jpg"
  },
  {
    ...
    name: "Alice Johnson",
    username: "@alicej",
    img: "/images/avatar/b/female (1).jpg"
  },
  {
    ...
    name: "Michael Brown",
    username: "@mikebrown",
    img: "/images/avatar/b/male (3).jpg"
  },
  {
    ...
    img: "/images/avatar/b/female (4).jpg"
  },
  {
    ...
    name: "David Kim",
    username: "@davidk",
    img: "/images/avatar/b/male (1).jpg"
  },
  {
    ...
    img: "/images/avatar/b/female (2).jpg"
  },
  {
    ...
    name: "Robert Johnson",
    username: "@robertj",
    img: "/images/avatar/b/male (4).jpg"
  },
  {
    ...
    name: "Emily Davis",
    username: "@emilyd",
    img: "/images/avatar/b/female (3).jpg"
  },
  {
    ...
    name: "Laura Martinez",
    username: "@lauram",
    img: "/images/avatar/b/female (5).jpg"
  }
]
          ...
          {reviews.map((review, index) => (<>
            {
              review.platform ? (<>
                <iframe
                  className="border-none w-full h-[350px] md:h-full rounded"
                ...
                <div key={index} className="bg-white rounded-lg p-5 border-[1px] border-gray-300">
                  <div className="">
                    {review.message}
                  </div>
