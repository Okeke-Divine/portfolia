        ...
        <>
            ...
            <Link href="/" target="_blank">
                <div className={`fixed ${variation == 0 ? "bottom-5" : "bottom-16"} right-5 bg-white rounded-full flex gap-x-1 items-center duration-300 shadow-md hover:shadow-lg group`}>
                    ...
                    <div className="pr-2 w-[0px] md:w-full duration-300 hidden group-hover:w-full  group-hover:block">Powered  by <span className="font-bold"> {config.app_name}</span> </div>
                </div>
            </Link>
        </>
    )
